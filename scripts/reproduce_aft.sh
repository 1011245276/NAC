...
echo "   TeCoA: https://nc.mlcloud.uni-tuebingen.de/index.php/s/92req4Pak5i56tX/download/tecoa_eps_4.pt"
echo "          -> save as ./checkpoints/tecoa_vit_b32.pth"
echo "   FARE:  https://nc.mlcloud.uni-tuebingen.de/index.php/s/jnQ2qmp9tst8kyQ/download/fare_eps_4.pt"
echo "          -> save as ./checkpoints/fare_vit_b32.pth"
