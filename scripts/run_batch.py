...
BASE = [
    ...
    "--imagenet_root", "F:/codex/NAC/data/imagenet-100/imagenet_folder",
    "--batch_size", "64",
]
...
experiments = [
    ...
    {"test_set": ["cifar10", "STL10"], "test_eps": "1", "counterattack": "momentum", "seed": "0", "outdir": "./results/momentum_eps1", "desc": "Momentum eps=1 C10+STL10"},
]

total = len(experiments)
logfile = "./results/batch_run.log"
